            ...
            <form  onSubmit={(event)=>{event.preventDefault()}}>
              <div style={{width:"100%" , direction:"rtl"}}>
               ...
               <div style={{width:"100%" , direction:"rtl"}}>
                ...
                <div>
                <button className={btnIsDisable? "disabled" :""} disabled={btnIsDisable} onClick={calculation} id="submit-loan-btn2" style={{width:"100%" , cursor:btnIsDisable ? "not-allowed":""}}>calculation</button>
              </div>
