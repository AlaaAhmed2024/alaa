...
// import amiriFont from "./Amiri-Regular.ttf.base64"; // تأكد من وجوده


import React, { useRef } from 'react';
export default function FirstDocm(props) {
...
const generateSndPdf = (props , mode = "save") => {
  ...
  // ✅ العنوان في المنتصف
  doc.setFontSize(14);
  doc.text("(سند لأمر السعي)", pageWidth / 2, y, { align: "center" });
  y += 17;
  ...
  const otherLines = [
    ...
    `وذلك مقابل أتعاب الوساطة لشراء عقار بمدينة: ${props.input.aqarCity}`,
  ];
  ...
  if (mode === "print") {
    ...
    window.open(doc.output("bloburl"), "_blank");
      ...
      doc.save(`سند-السعي أ/${props.input.customerName}.pdf`);
  }
};
    ...
    const printPdf = () => {
      ...
      const handleDownloadPdf = async () => {
        ...
        var textName="سند السعي  "+ props.input.customerName+".pdf"
        pdf.save(textName);
      };
  ...
  return (
    ...
    <div class="page" ref={pageRef} style={{ direction: 'rtl', textAlign: 'right'}}>
        <div class="subpage">
            ...
            <p style={{textAlign: "center"}}>(سند لأمر السعي)</p>
            <div>
...
<div>
            ...
            <div>
             ...
             <p>
             { "    وذلك مقابل اتعاب الوساطة لشراء عقار بمدينة   :  " + props.input.aqarCity }
               </p>
            </div>
