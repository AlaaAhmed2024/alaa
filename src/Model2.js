...
export default function Modal2({isVisble ,errorMassage=null }){
...
if(isVisble){
    return(
        <div id="modalLogIn" >
            <div id="modal-content-login" style={{backgroundColor:errorMassage ? "#ffafaf":"#ffffff" }}>
                <h5 style={{backgroundColor:"#ffafaf" ,position:"static" , zIndex:"10000" , color:errorMassage ? "#8d0000":"green" , textAlign: "center"}}>{errorMassage!=null? 
               ...
               :
                    ...
                    <strong >تم</strong>   البيانات صحيحه
                    <button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                  </div> 
